    ...
    getAll: async (req, res) => {
        ...
        try {
            ...
            const allowedSortColumns = ['name', 'quantity', 'code', 'description',
                'minimumQuantity', 'maximumQuantity', 'position', 'status', 'last_modified']; // ← ADICIONE last_modified
            ...
            const filtersForView = { ...req.query };
            delete filtersForView.success; // Remove success
            delete filtersForView.error;   // Remove error
            delete filtersForView.sort;    // Remove sort (já tratado em currentSort)
            delete filtersForView.order;   // Remove order
            delete filtersForView.page;    // Remove page
